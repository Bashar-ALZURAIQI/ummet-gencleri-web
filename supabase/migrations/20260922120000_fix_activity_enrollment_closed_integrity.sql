-- Fix activity enrollment integrity to prevent changes after evaluation is closed
BEGIN;
...
REVOKE EXECUTE ON FUNCTION public.set_own_activity_enrollment(uuid, public.activity_decision, text) FROM PUBLIC, anon, authenticated, service_role;
